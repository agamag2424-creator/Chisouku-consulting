  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full rounded-[8px] bg-[var(--color-cyan)] px-[24px] py-[14px] text-[11px] font-bold uppercase tracking-[0.14em] text-[var(--color-void)] transition-shadow hover:shadow-[0_0_20px_var(--color-cyan-glow)] disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto sm:rounded-l-none"
      >
        {isSubmitting ? "SAVING..." : "NOTIFY ME"}
      </button>
      {error && (
        <p
          className="w-full text-left text-[12px] text-[var(--color-red)] sm:col-span-2"
          aria-live="polite"
        >
          {error}
        </p>
