...
That API route forwards confirmed signups to a dedicated Google Apps Script Web App URL.
...
- `GOOGLE_APPS_SCRIPT_INSIGHTS_URL=<your_web_app_url>`
...
```bash
GOOGLE_APPS_SCRIPT_INSIGHTS_URL=https://script.google.com/macros/s/XXXX/exec
```

### Vercel

1. Vercel project -> `Settings` -> `Environment Variables`
2. Add key: `GOOGLE_APPS_SCRIPT_INSIGHTS_URL`
